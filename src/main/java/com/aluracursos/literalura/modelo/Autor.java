...
//Especificamos que es una entidad y creara una tabla en la base de datos de autores
@Entity
@Table(name = "autores")
public class Autor {
    @Id
    ...
    //fetch = FetchType.EAGER se usa para traer los libros de la base de datos
